...
impl AnalisisAtaque for Caballo{
    ...
    fn puedo_atacar_enemigo(&self, posicion_contrincante: (i16, i16)) -> bool{
        ...
        ((posicion_contrincante.0-self.fila).abs() == 1 && (posicion_contrincante.1-self.columna).abs() == 2) ||
        ((posicion_contrincante.0-self.fila).abs() == 2 && (posicion_contrincante.1-self.columna).abs() == 1)
    }
